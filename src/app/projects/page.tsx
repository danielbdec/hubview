            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <AnimatePresence>
                    {projects.map((project) => {
                        ...
                        // Determine Status
                        let status = 'PENDENTE';
                        let statusColor = 'text-[var(--muted-foreground)] border-[var(--muted-foreground)]';
                        ...
                        return (
                            ...
                            >
                                <Link href={`/projects/${project.id}`}>
                                    <div className="group relative bg-[var(--card)] border border-[var(--card-border)] hover:border-[var(--card-hover)] p-6 h-full transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(var(--primary),0.1)] flex flex-col">
                                        {/* Tech corner accents */}
